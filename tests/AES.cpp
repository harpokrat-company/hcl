...
//    std::cout << "Running test data " << i + 1 << "/" << tests_number << " of Rijndael 128 block cipher encryption test... "
//              << std::flush;
...
//  };
//  for (int i = 0; i < tests_number; ++i) {
//    std::cout << "Running test data " << i + 1 << "/" << tests_number << " of Rijndael 192 block cipher encryption test... "
//              << std::flush;
//    HCL::Crypto::Rijndael::AES192Encrypt(test_keys[i], test_data[i]);
//    if (CompareData(test_data[i], expected_ciphered_data[i]) != 0) {
//      std::cerr << "Error:" << std::endl;
...
//  };
//  for (int i = 0; i < tests_number; ++i) {
//    std::cout << "Running test data " << i + 1 << "/" << tests_number << " of Rijndael 256 block cipher encryption test... "
//              << std::flush;
//    HCL::Crypto::Rijndael::AES256Encrypt(test_keys[i], test_data[i]);
//    if (CompareData(test_data[i], expected_ciphered_data[i]) != 0) {
//      std::cerr << "Error:" << std::endl;
...
//  };
//  for (int i = 0; i < tests_number; ++i) {
//    std::cout << "Running test data " << i + 1 << "/" << tests_number << " of Rijndael 128 block cipher decryption test... "
//              << std::flush;
//    HCL::Crypto::Rijndael::AES128Decrypt(test_keys[i], test_data[i]);
...
//  };
//  for (int i = 0; i < tests_number; ++i) {
//    std::cout << "Running test data " << i + 1 << "/" << tests_number << " of Rijndael 192 block cipher decryption test... "
//              << std::flush;
//    HCL::Crypto::Rijndael::AES192Decrypt(test_keys[i], test_data[i]);
//    if (CompareData(test_data[i], expected_deciphered_data[i]) != 0) {
//      std::cerr << "Error:" << std::endl;
...
//  };
//  for (int i = 0; i < tests_number; ++i) {
//    std::cout << "Running test data " << i + 1 << "/" << tests_number << " of Rijndael 256 block cipher decryption test... "
//              << std::flush;
//    HCL::Crypto::Rijndael::AES256Decrypt(test_keys[i], test_data[i]);
//    if (CompareData(test_data[i], expected_deciphered_data[i]) != 0) {
//      std::cerr << "Error:" << std::endl;
