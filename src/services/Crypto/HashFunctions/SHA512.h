...
#ifndef HCL_SRC_SERVICES_CRYPTO_HASHFUNCTIONS_SHA512_H_
#define HCL_SRC_SERVICES_CRYPTO_HASHFUNCTIONS_SHA512_H_
...
class SHA512 : public AutoRegisterer<AHashFunction, SHA512>, public SHA2<uint64_t> {
 public:
  SHA512() = default;
 ...
 protected:
  ...
  uint64_t GetRoundConstant(size_t index) const override {
...
#endif //HCL_SRC_SERVICES_CRYPTO_HASHFUNCTIONS_SHA512_H_
