...
EMSCRIPTEN_BINDINGS(hcl) {
  ...
  emscripten::class_<HCL::ASecret>("Secret")
      .class_function("Deserialize", &HCL::ASecret::DeserializeSecretWasm, emscripten::allow_raw_pointers())
      .class_function("DeserializeAsymmetric", &HCL::ASecret::DeserializeSecretWasmAsymmetric, emscripten::allow_raw_pointers())
      .function("Serialize", &HCL::ASecret::SerializeWasm, emscripten::allow_raw_pointers())
      .function("SerializeAsymmetric", &HCL::ASecret::SerializeWasmAsymmetric, emscripten::allow_raw_pointers())
